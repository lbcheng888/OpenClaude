// @ts-nocheck
import {cZ,Nw,rie} from "./m2238.ts";
import {UQa,sho} from "./m4382.ts";
import {$Qa,qQa} from "./m4383.ts";
import {b} from "../runtime.ts";
function jQa(e,t,n,r=!1){return`# Dream: Memory Consolidation
...
- Read \`${Nw}\` to understand the current index
...
Update \`${Nw}\` so it stays under ${rie} lines AND under ~25KB. It's an **index**, not a dump \u2014 each entry should be one line under ~150 characters: \`- [Title](file.md) \u2014 one-line hook\`. Never write memory content directly into it.
