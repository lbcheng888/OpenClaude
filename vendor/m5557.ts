...
var Wnc=`# Verifying a CLI change
...
`;
var qnc=()=>{};
var Vnc=`# Verifying a server/API change
...
var Knc=()=>{};
var jnc={};
ft(jnc,{SKILL_MD:()=>Uqm,SKILL_FILES:()=>$qm});
var Uqm,$qm;
var Ync=b(()=>{qnc();Gnc();Knc();Uqm=znc,$qm={"examples/cli.md":Wnc,"examples/server.md":Vnc}});
export {Wnc,qnc,Vnc,Gnc,znc,Knc,jnc,Uqm,$qm,Ync};
