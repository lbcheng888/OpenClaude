...
function ownProcStart(){return Exr??=getProcessStartTime(process.pid)}
async function ownProcStartAsync(){return Exr??=await getProcessStartTimeAsync(process.pid)}
async function getProcessStartTimeAsync(e,t){let n=Date.now();if(!t?.skipCache){let i=xmn.get(e),a=i?.miss?H9u:k9u;if(i&&n-i.at<a)return i.p}let r=x9u(e),o={at:n,p:r};xmn.set(e,o);let s=await r;if(s===void 0&&xmn.get(e)===o)o.miss=!0;return s}
function _resetProcStartCacheForTesting(){xmn.clear(),Exr=void 0}
async function x9u(e){try{let t=await execFileNoThrowWithCwd("ps",["-o","lstart=","-p",String(e)],{timeout:1000,env:{...process.env,LC_ALL:"C",TZ:"UTC"}});return t.code===0&&t.stdout?t.stdout.trim():void 0}catch{return}}
...
var Exr,k9u=60000,H9u=5000,xmn;
var lE=b(()=>{Ii();ps();xmn=new Map});
export {xr,QT,AXe,isProcessRunning,sigtermThenKill,getAncestorPidsAsync,getProcessCommand,getProcessStartTime,isSameProcess,isSameProcessAsync,ownProcStart,ownProcStartAsync,getProcessStartTimeAsync,_resetProcStartCacheForTesting,x9u,getAncestorCommandsAsync,getChildPids,Exr,k9u,H9u,xmn,lE};
