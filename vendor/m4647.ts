...
import {oH,HE} from "../src/agent/3332_id.ts";
import {QR} from "../src/tools/2710_allErrors.ts";
import {LO} from "./m2707.ts";
var arm,Gyl;
var Vyl=b(()=>{oH();arm={type:"prompt",name:"init-verifiers",description:"Create verifier skill(s) for automated verification of code changes",contentLength:0,progressMessage:"analyzing your project and creating verifier skills",source:"builtin",async getPromptForCommand(){return[{type:"text",text:`Use the ${HE()?QR:LO} tool to track your progress through this multi-step task.
