...
var lge="EnterWorktree";
var qh="ToolSearch";
var fke={};
ft(fke,{PEWTER_OWL_TOOL_PROMPT:()=>PEWTER_OWL_TOOL_PROMPT,LEGACY_BRIEF_TOOL_NAME:()=>LEGACY_BRIEF_TOOL_NAME,DESCRIPTION:()=>DESCRIPTION,BRIEF_TOOL_PROMPT:()=>BRIEF_TOOL_PROMPT,BRIEF_TOOL_NAME:()=>BRIEF_TOOL_NAME,BRIEF_PROACTIVE_SECTION:()=>BRIEF_PROACTIVE_SECTION,BRIEF_ENFORCE_SENTINEL:()=>BRIEF_ENFORCE_SENTINEL});
...
var parsePermissionRule=b(()=>{BRIEF_PROACTIVE_SECTION=`## Talking to the user
...
export {lge,qh,fke,BRIEF_TOOL_NAME,LEGACY_BRIEF_TOOL_NAME,BRIEF_ENFORCE_SENTINEL,DESCRIPTION,BRIEF_TOOL_PROMPT,PEWTER_OWL_TOOL_PROMPT,BRIEF_PROACTIVE_SECTION,parsePermissionRule};
