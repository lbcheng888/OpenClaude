...
import {Nk,TE} from "../src/agent/3316_id.ts";
import {Kw} from "../src/tools/2698_allErrors.ts";
import {gL} from "./m2695.ts";
var szp,cdl;
var udl=b(()=>{Nk();szp={type:"prompt",name:"init-verifiers",description:"Create verifier skill(s) for automated verification of code changes",contentLength:0,progressMessage:"analyzing your project and creating verifier skills",source:"builtin",async getPromptForCommand(){return[{type:"text",text:`Use the ${TE()?Kw:gL} tool to track your progress through this multi-step task.
