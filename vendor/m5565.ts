...
`;
var eic=()=>{};
var ric=`# Example: Electron / desktop GUI app
...
`;
var oic=()=>{};
var aic=`# Example: Browser-driven web app
...
`;
var iic=()=>{};
var cic=`# Example: Web server / API
...
`;
var lic=()=>{};
var dic=`# Example: TUI / interactive terminal app
...
var pic=()=>{};
var uUo={};
ft(uUo,{SKILL_MD:()=>j5m,RUN_EXAMPLE_FILES:()=>RUN_EXAMPLE_FILES});
var j5m,RUN_EXAMPLE_FILES;
var dUo=b(()=>{eic();nic();oic();iic();lic();uic();pic();j5m=mic,RUN_EXAMPLE_FILES={"examples/cli.md":tic,"examples/electron.md":ric,"examples/library.md":sic,"examples/playwright.md":aic,"examples/server.md":cic,"examples/tui.md":dic}});
export {tic,eic,ric,nic,sic,oic,aic,iic,cic,lic,dic,uic,mic,pic,uUo,j5m,RUN_EXAMPLE_FILES,dUo};
