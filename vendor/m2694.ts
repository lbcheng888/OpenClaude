// @ts-nocheck
import {U1i,T2e} from "./m2680.ts";
import {Dh,NH} from "../src/config/2024_NH.ts";
import {b} from "../runtime.ts";
var Ntt="ConnectGitHub";
function CNi(e){let t=U1i();if(Dh(e))return`Search the web. Returns result blocks with titles and URLs. US-only.
...
`}
var initModelResolutionModule="WebSearch";
var Btt=b(()=>{T2e();NH()});
export {Ntt,CNi,initModelResolutionModule,Btt};
