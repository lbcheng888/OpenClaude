...
function eRp(){return`## What Happens in Plan Mode

In plan mode, you'll:
1. Thoroughly explore the codebase using ${Zw()&&Su()?`\`find\`/${yu}, \`grep\`/${$c}, and ${Ws}`:`${yu}, ${$c}, and ${Ws}`}
2. Understand existing patterns and architecture
3. Design an implementation approach
4. Present your plan to the user for approval
5. Use ${Fm} if you need to clarify approaches
6. Exit plan mode with ${Tk} when ready to implement
...
7. **User Preferences Matter**: The implementation could reasonably go multiple ways
   - If you would use ${Fm} to clarify the approach, use EnterPlanMode instead
...
`}
function Y2a(){return tRp()}
var J2a=b(()=>{bW();oA();Z1();ef();VR();Vw()});
export {eRp,tRp,Y2a,J2a};
