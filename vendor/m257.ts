// @ts-nocheck
import {jsonStringifyReplacer,Fd} from "./m256.ts";
import {b} from "../runtime.ts";
import {$7e,$constructor} from "./m255.ts";
...
`)}
var rGo=(e,t)=>{e.name="$ZodError",Object.defineProperty(e,"_zod",{value:e._zod,enumerable:!1}),Object.defineProperty(e,"issues",{value:t,enumerable:!1}),Object.defineProperty(e,"message",{get(){return JSON.stringify(t,jsonStringifyReplacer,2)},enumerable:!0})},$ZodError,$ZodRealError;
var fur=b(()=>{$7e();Fd();$ZodError=$constructor("$ZodError",rGo),$ZodRealError=$constructor("$ZodError",rGo,{Parent:Error})});
export {flattenError,formatError,treeifyError,toDotPath,prettifyError,rGo,$ZodError,$ZodRealError,fur};
