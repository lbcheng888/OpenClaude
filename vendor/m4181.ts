...
function p5e(e){wce.runInContext(`(() => {
...
function Dpt(e){return wce.runInContext("(async v => ({__proto__: null, v: await v}))",e)}
function pKa(e){return wce.runInContext("((fn, ...args) => fn(...args))",e)}
function Rqn(e){return wce.runInContext(`(e => {
...
function vqn(e){return wce.runInContext(`(() => {
      ...
      return (hostVal) => {
        ...
        function c(v) {
          ...
          if (_isArray(v)) {
            ...
            if (len > ${Aqn}) {
              throw capErr('array length ' + len + ' exceeds the maximum of ${Aqn} supported across the workflow VM boundary')
            }
...
function wqn(e){return wce.runInContext("(hostFn => async (...a) => hostFn(...a))",e)}
function kce(e,t="Error",n){let r=()=>`${t}: ${e}`;return Object.setPrototypeOf(r,null),{__proto__:null,name:t,message:e,stack:n??`${t}: ${e}`,toString:r}}
function cFp(){if(!Who){let e=wce.createContext({__proto__:null},{codeGeneration:{strings:!1,wasm:!1}});p5e(e),Who=wce.runInContext(`(e => {
...
function X4t(e){try{let t=cFp()(e);return{msg:typeof t.msg==="string"?t.msg:"<unprintable thrown value>",name:typeof t.name==="string"?t.name:"Error",stack:typeof t.stack==="string"?t.stack:void 0}}catch{return{msg:"<unprintable thrown value>",name:"Error"}}}
function kqn(e){if(e==null||typeof e!=="object"&&typeof e!=="function")return String(e);return`[${typeof e}]`}
function NY(e){let t=(...n)=>{try{return e(...n)}catch(r){let{msg:o,name:s,stack:i}=X4t(r);throw kce(o,s,i)}};return Object.setPrototypeOf(t,null),t}
function Hqn(e){let t=async(...n)=>{try{return await e(...n)}catch(r){let{msg:o,name:s,stack:i}=X4t(r);throw kce(o,s,i)}};return Object.setPrototypeOf(t,null),t}
function uKa(e){let t=Error(e);return Object.defineProperty(t,mKa,{value:!0}),t}
function dKa(e){try{return typeof e==="object"&&e!==null&&e[mKa]===!0}catch{return!1}}
function fKa(e){let t;try{t=e.length}catch{throw Error("unable to read array length across the workflow VM boundary")}if(typeof t!=="number"||!Number.isSafeInteger(t))throw uKa("array length is not a safe integer across the workflow VM boundary");if(t>Aqn)throw uKa(`array length ${t} exceeds the maximum of ${Aqn} supported across the workflow VM boundary`);return t}
function J4t(e,t=new WeakMap){if(typeof e==="function")return;if(e===null||typeof e!=="object")return e;let n=t.get(e);if(n!==void 0)return n;if(Array.isArray(e)){let s=[];t.set(e,s);let i=fKa(e);for(let a=0;a<i;a++)try{s[a]=J4t(e[a],t)}catch(l){if(dKa(l))throw l;s[a]=void 0}return s}let r={};t.set(e,r);let o;try{o=Object.keys(e)}catch{return r}for(let s of o){if(s==="__proto__")continue;try{let i=e[s];if(typeof i==="function")continue;r[s]=J4t(i,t)}catch(i){if(dKa(i))throw i}}return r}
function Iqn(e){if(e===null||typeof e!=="object")return[];let t=fKa(e),n=[];for(let r=0;r<t;r++)try{n[r]=e[r]}catch{n[r]=void 0}return n}
var wce,Aqn=4096,Who,mKa;
var Uye=b(()=>{wce=x(require("vm"));mKa=Symbol("vmArrayCap")});
export {p5e,Dpt,pKa,Rqn,vqn,wqn,kce,cFp,X4t,kqn,NY,Hqn,uKa,dKa,fKa,J4t,Iqn,wce,Aqn,Who,mKa,Uye};
