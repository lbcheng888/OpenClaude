...
// @ts-nocheck
function runOnceSideEffect() {
  if (sideEffectDone) return;
  sideEffectDone = true;
}
var sideEffectDone = false;
var skillMarkdownBody = `---
...
var SKILL_MD;
var initArtifactDesignSkill = b(() => {
  noopInitHook();
  SKILL_MD = skillMarkdownBody;
});

export {runOnceSideEffect as qtr,sideEffectDone as Qec,skillMarkdownBody as etc,noopInitHook as Zec,exportTable as ttc,SKILL_MD,initArtifactDesignSkill as ntc};
