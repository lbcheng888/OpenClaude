...
import {Nk as D2,E9e as xIH,TE as sD,KF as xC,p9 as HE} from "../agent/3316_id.ts";
import {kGa as lmK,RGa as cmK,xGa as dmK} from "../../vendor/m4267.ts";
import {we as kH} from "../../vendor/m455.ts";
import {E as k} from "../../vendor/m319.ts";
import {H0 as JL} from "../session/2690_resolveLoopFileFire.ts";
...
interface TaskRecord {
  ...
  owner?: string;
  blockedBy: string[];
  metadata?: { _internal?: boolean } & Record<string, unknown>;
}
...
var initTaskListTool = L(() => {
  ...
  taskListInputSchema = kH(() => k.strictObject({})), taskListOutputSchema = kH(() => k.object({
    ...
    async call(): Promise<{ data: TaskListToolOutput }> {
      let taskListId = xC(),
...
export {taskListInputSchema as sLp,taskListOutputSchema as iLp,taskListTool as HGa,initTaskListTool as IGa};
