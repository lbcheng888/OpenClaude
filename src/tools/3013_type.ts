...
import {mLt as Qh_,Nnt as SH_} from "../telemetry/2807__meta.ts";
import {o$e as jbH,Tq as pp} from "../../vendor/m2800.ts";
import {fGr as VU8,KGi as zp7,zGi as $p7,Sxn as vX6} from "../../vendor/m3011.ts";
import {we as kH} from "../../vendor/m455.ts";
import {E as k} from "../../vendor/m319.ts";
import {s3i as Wv7,o3i as Pv7} from "../../vendor/m2807.ts";
 ...
 */
declare const c9: <T extends { name: string }>(def: T) => T & { userFacingName: () => string };
...
type McpToolResultContent = string | Array<{ type: string; text?: string }>;
...
export {BW3 as LMd,UW3 as MMd,yU8 as AGr,Yp7 as YGi};
