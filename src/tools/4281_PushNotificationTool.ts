...
import {lt as w_,NOTIF_ACTIVE_THRESHOLD_MS as jd_,getIsRemoteMode as VK,yH as SR,isUserActiveForNotifications as ks6,getLastInteractionTime as yR,getTerminalFocus as fkH} from "../session/0131_sent.ts";
import {zn as o6,bK as iS} from "../api/2198_stopPeriodicGrowthBookRefresh.ts";
...
import {Ug as jf,bc as O5} from "../../vendor/m2264.ts";
import {aee as xzH,V5 as gg,rNi as cL7,oNi as dL7} from "../session/2687_aee.ts";
import {dVa as ypK,cVa as NpK,uVa as VpK} from "../../vendor/m4279.ts";
import {we as kH} from "../../vendor/m455.ts";
import {E as k} from "../../vendor/m319.ts";
import {st as q_,fromEnumOpt as A9} from "../../vendor/m5.ts";
// ---------------------------------------------------------------------------
...
declare function O5(key: string, fallback: boolean): { value: boolean };
...
var EpK = L(() => {
  ...
  dPO = kH(() => k.strictObject({
    ...
    async call(
      ...
      context: { options: { isNonInteractiveSession: boolean } },
      _abortSignal: unknown,
      _extra: unknown,
      onProgress?: (event: { type: string; message: string; notificationType: string }) => void
    ): Promise<{ data: PushNotificationOutput }> {
...
export {vpK as pVa,dPO as bLp,lPO as ELp,nPO as CLp,PushNotificationTool,EpK as mVa};
