...
import {lb as Lf,isAgentSwarmsEnabled as wK} from "../config/3314_isAgentSwarmsEnabled.ts";
import {Wd as YO,getTaskCompletedHookMessage as iI_} from "./5204_shouldSkipHookDueToTrust.ts";
import {tn as H6,TeamDeleteToolName as bH} from "../config/0230_encoding.ts";
import {oH as D2,O3e as xIH,HE as sD,gB as xC,Fee as oe,POn as LZ6,m_e as U$H,Eto as Ln8} from "../agent/3332_id.ts";
import {Op as mz,getAgentName as ZY,getTeamName as LT,getTeammateColor as ZW,getAgentId as ph} from "../agent/1464_waitForTeammatesToBecomeIdle.ts";
import {Pw as iW,writeToMailbox as T$} from "../permissions/3902_writeToMailbox.ts";
import {yto as yqq,xBt as Sb_} from "../../vendor/m3330.ts";
import {ve as kH} from "../../vendor/m461.ts";
import {C as k} from "../../vendor/m321.ts";
import {wD as _k} from "./2710_allErrors.ts";
import {executeTaskCompletedHooks as PpH} from "../../vendor/m5198.ts";
...
export {TASK_UPDATE_DESCRIPTION as WJa,TASK_UPDATE_PROMPT as GJa,taskUpdateInputSchema as C$p,taskUpdateOutputSchema as A$p,TaskUpdateTool as VJa,initTaskUpdateTool as KJa};
