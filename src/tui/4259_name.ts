...
function JmK(e, t, n) {
  return Yc.createElement(qn, null, Yc.createElement(B, {
    flexDirection: "column"
  }, Yc.createElement(w, null, "Switched to worktree", e.worktreeBranch ? Yc.createElement(w, null, " ", "on branch ", Yc.createElement(w, {
    bold: true
  }, e.worktreeBranch)) : null), Yc.createElement(w, {
    dimColor: true
  }, e.worktreePath)));
}
var Yc;
...
export {x5a as zWa,jmK as YWa,JmK as JWa,Yc as uG,MmK as XWa};
