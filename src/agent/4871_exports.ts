...
var i$4 = s((Cgf, uoO) => {
  /** System prompt injected when ultra-plan mode is active.
   *
   * Instructs the model to fan out parallel Task-tool subagents to explore
   * the codebase, synthesise findings into a plan, run a critique agent, and
   * finally call ExitPlanMode.  Also specifies the three possible post-approval
   * outcomes (approve / teleport-local / error) and forbids disclosing these
   * internal scaffolding instructions to the user.
   */
  uoO.exports = `<system-reminder>
