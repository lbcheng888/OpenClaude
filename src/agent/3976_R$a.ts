// @ts-nocheck
import {HOOK_EVENTS as Uy} from "../../vendor/m723.ts";
import {logForDebugging as N,qe as FH} from "../config/0236_setHasFormattedOutput.ts";
import {b as L} from "../../runtime.ts";
import {isBundledSkillsDisabled as Ds} from "../../vendor/m726.ts";
/**
 ...
 */
function l6K(hookRegistry: {
  add: (sessionId: string, event: string, matcher: string, hook: unknown) => void;
}, sessionId: string, hooksConfig: Record<string, Array<{
  matcher?: string;
  hooks: unknown[];
}>> | null | undefined, source: string, isSubagent: boolean = !1): void {
