...
import {Fr as I8,Fh as xY,Q9n as oS6,Ql as c4} from "../../vendor/m4405.ts";
import {_i as R7,hp as c3} from "../session/1460_promise.ts";
import {$ct as Q7_,qct as c7_} from "../core/4042_id.ts";
import {sZ as cs,Om as dT} from "../config/2215_level.ts";
import {hasSkipWorkflowUsageWarning as Ne_,updateSettingsForSource as Yq,yr as N8} from "../config/0740_updateSettingsForSource.ts";
...
/** Structured logger. */
declare function N(message: string, opts?: { level?: string }): void;
 ...
 */
function workflowNeedsUsageConsentPrompt(
  toolName: string,
...
export {workflowUsageConsentExports as xdo,workflowNeedsUsageConsentPrompt,recordWorkflowUsageConsent,initWorkflowUsageConsentModule as kdo};
