// @ts-nocheck
import {yA as G$,XI as mR,r8 as OF,F3 as wl} from "../../vendor/m459.ts";
import {b as L} from "../../runtime.ts";
import {ta as c7,wn as V6} from "../../vendor/m45.ts";
import {Dc as u1,fileSuffixForOauthConfig as Ra_} from "../api/0459_getOauthConfig.ts";
import {sn as A6,tr as Y8} from "./0047_namespace.ts";
import {ws as M9,jt as Q_} from "../../vendor/m228.ts";
import {ek as C0,Kzo as hQq} from "../core/0570_isCancel.ts";
...
var os: typeof import("os"),
  ...
  JETBRAINS_IDE_NAMES: string[],
  detectDeploymentEnvironment: () => string,
  /** Singleton platform info object exported by this module. */
  platformInfo: {
    hasInternetAccess: () => Promise<boolean>;
...
export {probeInternalNetworkAccess as O$c,checkCommandExists as t7e,isConductorApp as B$c,isWindsurfPath as pmr,detectTerminal as F$c,isSSH as Xzo,getHostPlatform as hbt,getShellBaseName as ven,getDefaultShell as mmr,os as zzo,path as Cen,getConfigFilePath as RH,hasInternetAccess as P$c,getPackageManagers as L$c,getRuntimes as M$c,isWslEnvironment as Yzo,isNpmFromWindowsPath as N$c,JETBRAINS_IDE_NAMES as initA8,detectDeploymentEnvironment as Jzo,platformInfo as n7e,KNOWN_SHELLS as U$c,Ys_ as wen};
