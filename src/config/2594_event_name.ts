...
import {VUe as OCH,QEn as vj6} from "./2593_ISSUES_EXPLAINER.ts";
import {getPromptId as s$_,getEventLogger as cs6,bufferPendingOTelEvent as ds6,lt as w_} from "../session/0131_sent.ts";
import {logForDebugging as N,qe as FH} from "./0234_setHasFormattedOutput.ts";
import {dyt as Sl_,xp as WO,Lb as LM,bt as L_} from "../../vendor/m195.ts";
 ...
 */
async function emitOtelLogEvent(
  eventName: string,
  ...
  if (!ds6(logRecord) && !hasWarnedAboutMissingLogger)
    hasWarnedAboutMissingLogger = !0,
    N(`[3P telemetry] Event dropped (no event logger initialized): ${eventName}`, {
      level: "warn"
    });
}
...
export {isLoggingUserPromptsEnabled as _hd,maybeRedactUserContent as ADt,emitOtelLogEvent as Ou,emitPermissionModeChangedEvent as wAe,emitCompactionEvent as Kwe,emitInternalErrorEvent as z0i,emitAtMentionEvent as W1,emitAuthEvent as KUe,otelEventSequence as ghd,hasWarnedAboutMissingLogger as K0i,isEmittingInternalError as Z3r,_j as uS};
