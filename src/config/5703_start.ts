...
import {gracefulShutdownSync as C1,ym as CT} from "./3332_flushAnalyticsSinks.ts";
import {b as L} from "../../runtime.ts";
/** Idle-exit timer: exits the process after CLAUDE_CODE_EXIT_AFTER_STOP_DELAY ms of idle time. */
function createIdleExitTimer(isIdleChecker: () => boolean): { start(): void; stop(): void } {
...
export {createIdleExitTimer as slc,initIdleExitModule as ilc};
