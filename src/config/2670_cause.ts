...
import {vu as N5,bt as L_} from "../../vendor/m195.ts";
import {b as L,M as u} from "../../runtime.ts";
import {ta as c7,wn as V6} from "../../vendor/m45.ts";
import {sn as A6} from "./0047_namespace.ts";
import {oa as l7,execFileNoThrow as B6} from "../../vendor/m684.ts";
import {wMi as jR7,dvn as gJ6} from "../../vendor/m2668.ts";
import {XI as mR,_A as WY,r8 as OF} from "../../vendor/m459.ts";
...
function getRipgrepPaths(): { rgPath: string; rgArgs: string[]; argv0: string | undefined } {
  let cfg = UR_();
  return {
    rgPath: cfg.command,
    rgArgs: cfg.args,
 ...
 */
function spawnRipgrepWithCallback(
  rgFlags: string[],
  searchDir: string,
  signal: AbortSignal,
  callback: RipgrepCallback,
  singleThreaded: boolean = !1
): ReturnType<typeof BR_.spawn> | ReturnType<typeof BR_.execFile> {
  let {
      rgPath: binaryPath,
      rgArgs: baseArgs,
      argv0: argv0Override
 ...
 * stdout.
 */
async function countFilesWithRipgrep(
  rgFlags: string[],
  searchDir: string,
  signal: AbortSignal
): Promise<number> {
...
function getRipgrepInfo(): { mode: RipgrepMode; path: string; working: boolean | null } {
  let cfg = UR_();
  return {
    mode: cfg.mode,
    path: cfg.command,
...
var BR_: typeof import("child_process"),
  ...
  Rx8: { default: typeof import("path") },
  UR_: (() => RipgrepConfig) & { cache?: { clear?: () => void } },
  ...
  QJ6: {
    new(message: string, partialResults: string[]): Error & { partialResults: string[]; name: string };
  },
  /** countFilesRoundedRg — memoised rounded file-count helper. */
  cJ6: ((searchDir: string, signal: AbortSignal, ignoreGlobs?: string[]) => Promise<number | undefined>) & { cache?: { clear?: () => void } },
  ...
  WR7: (() => Promise<void>) & { cache?: { clear?: () => void } };
...
export {wrapRipgrepEnoent as HMi,getRipgrepPaths as f2e,isEagainError as RMi,spawnRipgrepWithCallback as xMi,countFilesWithRipgrep as YSd,runRipgrepFileSearch as tae,getRipgrepInfo as IMi,clearRipgrepCache as PMi,BR_ as zDt,MR7 as kMi,Rx8 as Vqr,UR_ as YDt,XO3 as KSd,pR_ as KDt,PO3 as zSd,QJ6 as pvn,cJ6 as mvn,YeH as utt,WR7 as DMi,we as oee};
