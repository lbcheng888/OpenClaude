...
import {lc as O5,mg as jf} from "../../vendor/m2209.ts";
import {lrn as As_,rI as kh} from "../config/0586_rI.ts";
...
declare function O5<T>(settingKey: string, defaultValue: T): {
  value: T;
};
...
var Pz3: string = "<routine_summary>",
  ...
  cL7: string = "Send a notification to the user via their terminal and, when Remote Control is connected, also push to their mobile device",
  /**
...
export {vu8 as HVr,UL7 as F9i,gL7 as U9i,FL7 as B9i,gg as aW,MPH as pae,Eu8 as $kn,XPH as uke,dL7 as W9i,Pz3 as wPd,cL7 as q9i,QL7 as $9i,Wz3 as kPd,xzH as oee};
