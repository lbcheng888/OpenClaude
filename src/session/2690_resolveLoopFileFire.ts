...
import {tNi as gL7,Q6r as vu8,wRe as XPH,V5 as gg,Z1i as UL7,eNi as FL7,aee as xzH} from "./2687_aee.ts";
import {logEvent as c,Ct as y_} from "../../vendor/m131.ts";
import {Mh as vY,RRe as PPH,Ott as CeH,GAe as uzH} from "../core/2689_GAe.ts";
import {getProjectRoot as I1,lt as w_} from "./0131_sent.ts";
import {tr as Y8,sn as A6} from "../config/0047_namespace.ts";
import {ds as $7,dn as L6,bt as L_} from "../../vendor/m195.ts";
import {hz as Ii,TC as aM} from "../telemetry/2688_hz.ts";
...
function buildPushNotificationGuidance(isLoopFileMode: boolean = !1): string {
  ...
  let blockedCondition =
    !isLoopFileMode && isLoopPersistentPreambleEnabled()
 ...
 */
function readLoopFile(): { path: string; content: string } | null {
...
var fs: typeof import("fs"), // Node fs module (assigned in the initializer below).
  bu8: typeof import("path"), // Node path module (assigned below).
  AUTONOMOUS_LOOP_PREAMBLE: string, // Public alias of the default preamble text.
  dynamicPacingReminder: string, // Dynamic-pacing reminder block (built in the initializer).
  preambleDelivered: boolean = !1, // Whether the preamble has been delivered this loop run.
  lastLoopContent: string | null = null, // Last delivered loop content / preamble marker.
  PREAMBLE_DELIVERED_MARKER = "__autonomous_preamble__", // Sentinel content stored once the autonomous preamble has been sent.
...
export {JL as H0,Hk as pP,taskStopToolDescription as aNi,loopExports as S2e,isLoopPersistentPreambleEnabled,getAutonomousLoopPreamble,logAutonomousLoopActivation,buildPushNotificationGuidance as HPt,buildAutonomousTickPrompt as uNi,buildAutonomousDynamicTickPrompt as ZEd,isLoopDefaultPromptEnabled,isAutonomousLoopSentinel,resolveAutonomousLoopFire,buildLoopFileTickPrompt as eCd,buildLoopFileDynamicTickPrompt as tCd,buildLoopFileMissingDynamicTickPrompt as nCd,truncateLoopFileContent as rCd,readLoopFile,isLoopFileSentinel,resolveLoopFileFire,isLoopDefaultSentinel,resolveLoopDefaultFire,resetAutonomousLoopDelivered,fs as cNi,bu8 as tjr,AUTONOMOUS_LOOP_PREAMBLE,dynamicPacingReminder as ojr,preambleDelivered as kPt,lastLoopContent as Ltt,PREAMBLE_DELIVERED_MARKER as lNi,LOOP_FILE_SENTINEL,LOOP_FILE_DYNAMIC_SENTINEL,LOOP_FILE_MAX_BYTES as Zvn,initLoopModule as b2e};
