// @ts-nocheck
import {recordFileHistorySnapshot as cUt,ja as za} from "../permissions/5143_writeRemoteAgentMetadata.ts";
...
import {ec as Dl,Dd as Sd} from "../../vendor/m687.ts";
import {getIsNonInteractiveSession as kr,getSessionId as kt,getOriginalCwd as gr,lt as ct} from "./0131_sent.ts";
import {bc as Sc,Ug as jg} from "../../vendor/m2264.ts";
import {je as Ge} from "../../vendor/m577.ts";
import {st as rt} from "../../vendor/m5.ts";
import {Pn as Dn,dn as ln,ds as ls,bt as St} from "../../vendor/m195.ts";
import {ud as pd,mc} from "../config/0645_maxBytes.ts";
import {rxe as FRe} from "../../vendor/m2758.ts";
import {tr as sr,sn as an} from "../config/0047_namespace.ts";
import {dxe as KRe,Q2e as H2e} from "../telemetry/2780_eventName.ts";
...
export {reduceFileHistoryAction as p4e,isFileCheckpointingEnabled as vT,isFileCheckpointingEnabledForSdk as NAp,trackFileEdit as UHe,makeSnapshotForMessage as nlt,rewindToSnapshot as GBn,hasSnapshotForMessage as VBn,computeRewindDiffStats as DUt,applySnapshotToFilesystem as BAp,hasFileChangedSinceBackup as h0a,compareFileStats as FAp,computeFileDiffStats as UAp,buildBackupFileName as $Ap,resolveBackupFilePath as d4e,createBackupFile as g0a,copyBackupToTarget as qAp,findEarliestBackupFileName as _0a,normalizeToRelativePath as y0a,resolveToAbsolutePath as KBn,initFileHistoryFromLegacy as zBn,copyBackupsOnSessionRestore as YBn,syncFileHistoryToDisk as jAp,readFileOrNull as WBn,debugPrintState as m0a,cryptoModule as f0a,fsPromises as wE,pathModule as UW,utilModule as A0a,MAX_SNAPSHOT_COUNT as p0a,isDebugStateEnabled as WAp,s6 as _6};
