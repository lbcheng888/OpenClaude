// @ts-nocheck
import {eot as oeH,tot as aeH,Kk as TZ,po as zq} from "../tools/5224_userPromptCount.ts";
import {nw as kG} from "../../vendor/m2215.ts";
import {TeamDeleteToolName as bH,tn as H6} from "../config/0230_encoding.ts";
import {WA as T2,fW as rg} from "../api/4438_type.ts";
 ...
 */
function nk7(H: TranscriptEntry[]): {
  usage: Usage;
  anchorIndex: number;
} | null {
  let _ = H.length - 1;
...
export {P7H as yae,lk7 as cqi,We as lee,gi as Zz,sm8 as n7r,reH as Zrt,aD6 as mHn,sD6 as fHn,z2 as CC,nk7 as uqi,ik7 as dqi,Uv as g1};
