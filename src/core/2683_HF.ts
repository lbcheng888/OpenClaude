...
type ContentBlock =
  ...
  | { type: "image" }
  | { type: "document" }
  | { type: "tool_result"; content: TokenCountableContent }
...
export {estimateTokensFromLength as $f,charsPerTokenForFormat as NEd,estimateTokensForFormat as G1i,estimateContentTokens as CRe,estimateContentBlockTokens as BEd,ZC as HF};
