// @ts-nocheck
import {f3 as O3,T0 as ZI} from "../mcp/0733_serverName.ts";
import {HZe as fXe,tUr as ULr,gxt as hkt} from "../api/2050_type.ts";
import {Td as Gp,Cb as NC} from "../../vendor/m5036.ts";
...
export {registerDesignSyncSlashCommand as Mtc,uOm as p4m,yVl as Ntc,designSyncDescription as d4m,initDesignSyncCommand as Ftc};
