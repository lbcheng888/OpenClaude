...
/*
 * core/5453_exports.ts - embedded core asset restoration.
 *
 ...
 */
var wU4 = s((VkJ: any, WWT: any): any => {
  WWT.exports = `// CSS handling: token-file copy, @font-face extraction, and the final
