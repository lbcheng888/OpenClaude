...
import {firstPartyNameToCanonical,getMarketingNameForModel,DEFAULT_3P_SONNET_KEY,Mo,DEFAULT_3P_OPUS_KEY,DEFAULT_3P_HAIKU_KEY} from "../permissions/1453_swapShrinksContextWindow.ts";
import {bd,z2} from "../../vendor/m1280.ts";
import {getAPIProvider,li} from "./1282_usesFirstPartyModelIds.ts";
import {st,fromNumber,fromEnum} from "../../vendor/m5.ts";
import {logEvent,Ct} from "../../vendor/m131.ts";
import {ky,eQe} from "../mcp/2194_mcpServerName.ts";
import {logForDebugging,qe} from "../config/0234_setHasFormattedOutput.ts";
import {WAn,jAn} from "../core/2019_default.ts";
import {Z_,D1e} from "../config/1021_shouldBypassProxyWithCidr.ts";
import {refreshGcpCredentialsIfNeeded,Ao} from "../config/2031_withOAuthRefreshLock.ts";
import {buildVertexGoogleAuth,GAn} from "../../vendor/m2019.ts";
import {yre,yWe,sn} from "../config/0047_namespace.ts";
var I1o = {};
...
export {I1o,H1o,Koc,vertexUpgradeKey,findVertexUpgradeCandidates,checkVertexDefaultAvailability,p3m,m3m,probeVertexModel,TVt,oZn,D1o};
