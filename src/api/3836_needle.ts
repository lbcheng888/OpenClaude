// @ts-nocheck
import {qoe as c8H,Gze as anH,gme as HOH} from "../config/1280_BedrockClient.ts";
...
import {getAWSClientProxyConfig as DnH,Z_ as Af,D1e as MnH} from "../config/1021_shouldBypassProxyWithCidr.ts";
import {nwr as bJ8,twr as CJ8} from "../../vendor/m1350.ts";
import {avt as dD_,ivt as cD_} from "../../vendor/m1179.ts";
import {$l as T1,X2 as bm} from "../../vendor/m1450.ts";
import {JYe as Z2_,YYe as W2_} from "../core/1616_default.ts";
import {dYe as PiH,uYe as XiH} from "../../vendor/m1442.ts";
...
async function probeBedrockModel(config: BedrockAuthConfig, model: string): Promise<ProbeResult> {
  ...
  try {
    ...
    let status = (err as { status?: number } | null)?.status;
 ...
 */
function describeBedrockError(error: unknown, config: BedrockAuthConfig): { error?: string; command?: string } {
  let err = error as { name?: string; message?: string } | null,
    name = err?.name ?? "Error",
...
export {getBedrockModelMappings as coo,evK as rIa,probeBedrockModel as o4e,createBedrockClientForProbe as Zfp,resolveBedrockAuth as eAp,validateBedrockBearerKey as tAp,resolveAwsCredentialsProvider as oIa,describeBedrockError as nAp,W9q as uoo};
