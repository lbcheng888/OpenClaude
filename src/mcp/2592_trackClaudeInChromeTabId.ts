...
import {Jo as $7,Ct as L_} from "../../vendor/m197.ts";
import {Rm as G$,tI as mR} from "../../vendor/m465.ts";
import {ac as O1} from "./0733_serverName.ts";
import {xe as IH,He as vH,mn as M6} from "../telemetry/0600_feature_name.ts";
import {execFileNoThrow as B6,Ii as l7} from "../../vendor/m690.ts";
import {xF as Mp,resolveToolAlias as CW} from "../config/2229_observed_uid.ts";
...
export {claudeInChromeExports as nNi,isInProductPermissionsEnabled,getAllBrowserDataPaths,getAllNativeMessagingHostsDirs,getAllWindowsRegistryKeys,detectAvailableBrowser,isClaudeInChromeMCPServer,trackClaudeInChromeTabId,isTrackedClaudeInChromeTabId,_resetTrackedTabIdsForTesting,openInChrome,getSocketDir,getSecureSocketPath,getAllSocketPaths,getWindowsPipeName as tNi,getCurrentUsername as _8r,fs as Z1i,fsPromises as d8r,os as Mhe,path as X8,CLAUDE_IN_CHROME_MCP_SERVER_NAME,CFC_TOOL_PREFIX,CLAUDE_IN_CHROME_DOMAIN_RULE_TOOL,CHROMIUM_BROWSERS,BROWSER_DETECTION_ORDER,MAX_TRACKED_TAB_IDS as Evd,trackedTabIds as Lnt,initModule as bO};
