// @ts-nocheck
import {fromSanitizer_SANITIZER_OUTPUT_ONLY as sZ,fromEnum as tH} from "../../vendor/m5.ts";
...
function logFileOperation(params: {
  ...
  if (params.content !== void 0 && params.content.length <= MAX_CONTENT_HASH_BYTES)
    props.contentHash = hashContentFull(params.content);
  if (params.type !== void 0)
    props.type = tH(params.type);
...
export {hashFilePathShort as Twp,hashContentFull as Swp,logFileOperation as Wte,cryptoModule as Olo,MAX_CONTENT_HASH_BYTES as bwp,kv6 as e$n};
