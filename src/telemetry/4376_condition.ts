...
import {gIe as jGH,x9 as tx} from "../../vendor/m4033.ts";
import {h$ as iI,eie as tqH,L1 as Pv} from "../../vendor/m2232.ts";
import {getIsNonInteractiveSession as u8,getSessionId as v_,getTotalOutputTokens as JJ,lt as w_} from "../session/0131_sent.ts";
import {checkHasTrustDialogAccepted as QO,Qn as T8} from "../session/5194_shouldSkipPluginAutoupdate.ts";
import {isTmuxControlMode as n_,Ie as vH,ln as M6} from "./0594_feature_name.ts";
 ...
 */
function getGoalStopHooks(appState: unknown, sessionId: string): Array<{ type: "prompt"; prompt: string }> {
  let promptHooks: Array<{ type: "prompt"; prompt: string }> = [];
 ...
 */
var buildGoalActivationPrompt = (condition: string) =>
...
export {isGoalClearCommand as Gqn,findMetGoalStatus as vQa,formatLastCheckLabel as wQa,getGoalStopHooks as Jdt,checkGoalGate as tho,setGoal as Xdt,clearGoal as Qdt,createGoalStatusAttachment as RQa,cryptoModule as CQa,GOAL_CONDITION_MAX_LENGTH as Ydt,GOAL_CLEAR_KEYWORDS as r$p,buildGoalActivationPrompt as Vqn,TRUST_GATE_MESSAGE as o$p,HOOKS_GATE_MESSAGE as s$p,opH as F6e};
