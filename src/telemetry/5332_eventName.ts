// @ts-nocheck
import {X4 as ap,uS as j2} from "../config/3192_path.ts";
...
function TE4(ideClients: unknown[]): void {
  OE4.useEffect(() => {
    ...
    if (ideSession) ideSession.client.setNotificationHandler(RAT(), (notification: {
      params: {
        eventName: string;
...
export {TE4 as d7l,OE4 as u7l,RAT as e1m,zE4 as p7l};
