// @ts-nocheck
import {getDynamicConfig_CACHED_MAY_BE_STALE as Uh,jn as o6} from "../api/2204_stopPeriodicGrowthBookRefresh.ts";
import {getSubscriptionType as YK,lo as Mq} from "../config/2036_withOAuthRefreshLock.ts";
...
var defaultComputerUseConfig: ComputerUseConfig, /** Lazily populated cache for the coordinate mode value. */
...
export {getMalortPedwayConfig as $Qr,isMaxOrProSubscriber as Bjd,isComputerUseEnabled as GDn,getComputerUseOptions as VDn,getCachedCoordinateMode as cit,defaultComputerUseConfig as jca,cachedCoordinateMode as Yca,Y6_ as uit};
