// @ts-nocheck
import {ft as j_,oo as b8,b as L} from "../../runtime.ts";
import {getFeatureValue_CACHED_MAY_BE_STALE as Y_,checkGate_CACHED_OR_BLOCKING as rS,jn as o6} from "../api/2204_stopPeriodicGrowthBookRefresh.ts";
import {_B as pC,$Bt as Vy_} from "./5226_waitForPolicyLimitsToLoad.ts";
import {Bu as i5,dDt as _2_} from "../../vendor/m2213.ts";
import {qOn as qG6,Tga as f9K,M3e as zxH} from "../../vendor/m3341.ts";
...
import {Nrn as ps_,Es as y9} from "../../vendor/m641.ts";
import {Ce as GH,Ct as L_} from "../../vendor/m197.ts";
import {xe as IH,He as vH,mn as M6} from "./0600_feature_name.ts";
...
async function recoverFromUntrustedDevice(staleToken: string): Promise<string | undefined> {
  ...
  if (!currentToken || currentToken === staleToken) {
    if (Date.now() - enrollBackoffTimestamp >= ENROLL_BACKOFF_MS) enrollBackoffTimestamp = Date.now(), await enrollTrustedDevice({
      serverRequested: !0
...
var osModule: typeof import("os"),
  ...
  readStoredTrustedDeviceToken: (() => Promise<string | undefined>) & {
...
export {JG6 as KOn,isProactiveEnrollmentDisabled,getPolicyLimitsLoader as Vep,getOrgPolicyChecker as xto,isTrustedDeviceGateEnabled,isTrustedDeviceActiveForOrg,getAttestationFilterPolicy,getTrustedDeviceToken,isTrustedDeviceUnenrolled,getTrustedDeviceUnenrolledReason,clearTrustedDeviceTokenCache,_resetEnrollBackoffForTesting,recoverFromUntrustedDevice,untrustedDeviceHint,enrollTrustedDeviceIfNeeded,clearTrustedDeviceToken,enrollTrustedDevice,osModule as Ega,fG6 as GOn,yy_ as MBt,h9K as Cga,ENROLL_BACKOFF_MS as Gep,enrollBackoffTimestamp as Ito,PROACTIVE_ENROLLMENT_DISABLED_MESSAGE,readStoredTrustedDeviceToken,hr as Fj};
