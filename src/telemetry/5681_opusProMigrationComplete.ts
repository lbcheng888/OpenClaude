...
import {isProSubscriber as AOH,Ao as Mq} from "../config/2031_withOAuthRefreshLock.ts";
...
declare function C_(): { opusProMigrationComplete?: boolean; [key: string]: unknown };
 ...
 */
declare function nq(): { model?: string; [key: string]: unknown } | undefined;
