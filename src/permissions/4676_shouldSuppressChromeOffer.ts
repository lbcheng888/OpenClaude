...
import {getIsNonInteractiveSession as u8,getChromeFlagOverride as ya,getIsInteractive as N0,getSessionBypassPermissionsMode as U$_,lt as w_} from "../session/0132_sent.ts";
import {getGlobalConfig as C_,saveGlobalConfig as P6,tr as T8} from "../session/5228_shouldSkipPluginAutoupdate.ts";
import {isClaudeAISubscriber as Lq,lo as Mq} from "../config/2036_withOAuthRefreshLock.ts";
import {getFeatureValue_CACHED_MAY_BE_STALE as Y_,jn as o6} from "../api/2204_stopPeriodicGrowthBookRefresh.ts";
import {CLAUDE_IN_CHROME_MCP_SERVER_NAME as sh,getAllNativeMessagingHostsDirs as zb8,openInChrome as oG_,getAllWindowsRegistryKeys as $b8,getAllBrowserDataPaths as Tb8,bO as gN} from "../mcp/2592_trackClaudeInChromeTabId.ts";
import {Rf as WY} from "../../vendor/m465.ts";
import {logForDebugging as N,qe as FH} from "../config/0236_setHasFormattedOutput.ts";
import {lEo as OOq,dGn as Tm6} from "../../vendor/m4444.ts";
...
import {_Sl as F74,ySl as g74} from "../../vendor/m4674.ts";
...
export {nYq as Lvo,shouldEnableClaudeInChrome,shouldAutoEnableClaudeInChrome,_resetShouldAutoEnableForTesting,isClaudeInChromeWiredThisSession,_resetClaudeInChromeWiredForTesting,markClaudeInChromeUnwired,markClaudeInChromeUnwiredIfChrome,shouldSuppressChromeOffer,getClaudeInChromeMcpServerConfig,setupClaudeInChrome,getNativeHostManifestDirs as Prm,installChromeNativeHostManifest,registerNativeHostInWindowsRegistry as Orm,createChromeNativeHostWrapperScript as SSl,checkAndCacheChromeExtensionInstalled as Lrm,isChromeExtensionInstalled,y_H as gne,d74 as bSl,mo as mJ,gYq as Ivo,jFO as Irm,QYq as xvo,Q74 as TSl,cachedAutoEnableResult as dWt,claudeInChromeWiredThisSession as pWt,D1H as kTe};
